...
{
    public class Button : ContentProcessorItem
    {
        double Width;
        double Height;
        ButtonState Status;
        ...
        public Button(string contentName, double X, double Y, double Width, double Height)
            : base(contentName, X, Y)
        {
            this.Width = Width;
            this.Height = Height;
        ...
        public override IEnumerable<ContentDrawable> GetContentDarawable() 
        {
            ...
            if (Enabled)
            {
                drawItem.ContentName = this.ContentName;
